...
<body>
    ...
    %>
    <br>
    <a href="Lesson09FormPostValidation.html">Back To Form</a>
    <%                            
            response.end
        elseif len(StdName) < 3 then
            'response.write("Student Name must be of atleast 3 characters")
            response.redirect "Lesson09FormPostValidation.asp?ErrorMsg=Student Name must be of atleast 3 characters"
